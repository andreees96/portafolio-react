          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                <a href="https://www.linkedin.com/in/andres-maldonado-vidal/" target='_blank'><img src={navIcon1} alt="" /></a>
                <a href="https://github.com/andreees96" target='_blank'><img src={navIcon2} alt="" /></a>
